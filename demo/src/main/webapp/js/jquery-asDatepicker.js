...
(function($, document, window, undefined) {
    ...
    var Plugin = $[pluginName] = function(element, options) {
        ...
        this.$inputIcon = $('<i style="position:absolue;margin-left:450px;top:-34px" class="glyphicon glyphicon-calendar"></i>');
    ...
    Plugin.localize('zhong', {
        days: ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"],
        daysShort: ["日", "一", "二", "三", "四", "五", "六"],
        months: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "月"],
